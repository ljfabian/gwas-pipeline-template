...
- `08_regenie.p2.sh`: Finish GWAS analysis using regenie. Performs single-variant association testing based on the prediction models from step 1. Uses linear regression. Outputs `egg_{pheno}.regenie` files for each pheno column in phenotype file. Options used:
    - bsize = *4000*
